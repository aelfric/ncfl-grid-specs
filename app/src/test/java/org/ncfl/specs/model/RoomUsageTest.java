...
class RoomUsageTest {
    String json = """
            {
          "NCFL Activity": "Congress Meeting Room",
          "A/V Needs": "Table Microphone",
          "Venue": "Hilton Chicago",
          "Start": "7:00 AM",
          "Room Name/Number": "Williford C",
          "Room Turn ?": "",
          "Hotel Notes": "",
          "Hotel Floor": "3",
          "Date": "May 26",
          "Room Set": "Debate - Elim",
          "Internal Notes": "Set as Debate Elim to prep for that without a turn",
          "Catering ?": "",
          "End": "7:30 AM",
          "Day": "Sunday",
          "REB3 Updated": "",
    ...
    void testDeserialize() throws JsonProcessingException {
        ...
        assertThat(roomUsage.date().getYear(), equalTo(2025));
